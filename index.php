...
<header class="bg-light p-3">
    <div class="container d-flex justify-content-between align-items-center">
        <h1 class="m-0"><img src="img/Poke_Ball.png" alt="logo"  height="48px"> POKEDEX</h1>
        ...
        <table class="table">
            ...
            try {
                ...
                while($pokemon = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>";
                    echo "<td><a href='pokemon-vista.php?idpokemon=" . $pokemon["id"] . "'><img src='img/" . $pokemon["imagen"] . "' alt='" . $pokemon["nombre"] . "' width='80px' height='80px'></a></td>";
